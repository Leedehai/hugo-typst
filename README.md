...
Step 2. As with LaTeX
Step 2. in Markdown files, write your math equation in Typst.
```markdown
```
...
# Ensure you have Make. If not, you will need to execute the
# build steps in Makefile instead.
$ make --version
GNU Make 3.81
